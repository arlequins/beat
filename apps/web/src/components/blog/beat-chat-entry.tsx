...
export function BeatChatEntry() {
  ...
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-50 flex items-center gap-3 border border-[#f6c85f]/70 bg-[#111326] px-4 py-3 text-white shadow-[0.35rem_0.35rem_0_#f06449] transition hover:-translate-y-1 hover:border-[#79e6e0] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#79e6e0] sm:right-8 sm:bottom-8"
      href={destination}
      rel="noopener noreferrer"
      target="_blank"
    >
      <span className="flex size-9 items-center justify-center bg-[#f06449] text-white">
